...
u4 = User.create(username: 'john123', password: 'jo12345', firstname:'John', lastname:'Smith', email: 'john@gmail.com', role: 'Agent', avatar: 'https://i.pinimg.com/564x/9e/57/8b/9e578b47678afbfd98ea369302875f55.jpg', zipcode: 77494)
u5 = User.create(username: 'gra123', password: 'gr12345', firstname:'Grace', lastname:'Davis', email: 'grace@gmail.com', role: 'Agent', avatar: 'https://i.pinimg.com/564x/c5/51/01/c551016922f299df4dc6f2b3b159c251.jpg', zipcode: 77079)
u6 = User.create(username: 'kev123', password: 'ke12345', firstname:'Kevin', lastname:'Williams', email: 'kevin@gmail.com', role: 'Agent', avatar: 'https://i.pinimg.com/564x/cc/3d/12/cc3d1272697f1831a855e0d5caf6afbe.jpg', zipcode: 77094)
u7 = User.create(username: 'Eve123', password: 'ev12345', firstname:'Evelyn', lastname:'Lopez', email: 'evelyn@gmail.com', role: 'Agent', avatar: 'https://i.pinimg.com/564x/ee/d1/22/eed122f6177cabd54c6acf2cf8af37c6.jpg', zipcode: 77077)
u8 = User.create(username: 'mich123', password: 'mi12345', firstname:'Michael', lastname:'Miller', email: 'michael@gmail.com', role: 'Agent', avatar: 'https://i.pinimg.com/564x/ba/07/79/ba07791074b2951ab88be5e851f3e469.jpg', zipcode: 77041)
